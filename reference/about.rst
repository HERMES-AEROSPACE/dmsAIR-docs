...
hypersonic-flight atmospheric chemistry.
...
- `PLATO <https://hermes-aerospace.github.io/plato-docs/>`_ — plasma and gas
  kinetics library, used as the Master-Equation reference for validation
- `CoarseAIR <https://github.com/simoneventuri/CoarseAIR>`_ — PES and QCT
  trajectory back-end, linked as an external dependency

License
-------

Released under the MIT License — see the
`LICENSE <https://github.com/ClementCivrais/dmsAIR/blob/main/LICENSE>`_
